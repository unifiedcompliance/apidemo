<template>
  <div class="full-height">
    ...
    <div id="right" class="column siteWrap">
      ...
      <ucsubheader @changePage="changePage" :submenu="submenu" selPage="Initiatives"></ucsubheader>
          ...
          <div class="col-md-4">
            <div class=“table-responsive”>
              <table class="table table-bordered table-striped table-characters" id="grpTbl">
                ...
                <tbody>
                <tr v-for="initiative in results.initiatives">
                  <td @click="setInitiativeInfo(initiative.id)">{{initiative.name}}</td>
                  <td>{{initiative.active_status}}</td>
                </tr>
                </tbody>
              </table>
            </div>
            ...
            <div class="panel with-nav-tabs panel-default">
              <div class="panel-heading">
                <ul class="nav nav-tabs">
                  <li class="dropdown">
                    <a href="#tab1default" data-toggle="tab" id="initiativetab1">Initiative Info</a></li>
                  <li><a href="#tab2default" data-toggle="tab" @click="showGroups()">Groups</a></li>
                  <li><a href="#tab3default" data-toggle="tab" @click="showUsers()">Users</a></li>
                  <li><a href="#tab4default" data-toggle="tab" @click="showLists()">AD Lists</a></li>
                </ul>
              </div>
              <div class="panel-body">
                <div class="tab-content">
                  <div class="tab-pane fade in active" id="tab1default">
                    <div class="box margin-top-20"><span class="box-title">Initiative Basics</span>
                      <div class="row">
                      <div class="col-sm-4 no-padding">
                        <div class="form-group">
                          <label>Start Date</label>
                          <input type="text" class="form-control contactinfoinpt" placeholder="" :value="selInfo.start_date" disabled="">
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label>End Date</label>
                          <input type="text" class="form-control contactinfoinpt" placeholder="" :value="selInfo.end_date" disabled="">
                        </div>
                      </div>
                    </div>
                      <div class="row">
              <div class="col-sm-8 no-padding">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control contactinfoinpt" placeholder="" :value="selInfo.id" disabled="">
                        ...
                        <div class="row">
                          <div class="form-group">
                            ...
                            <textarea class="form-control contactinfoinpt" placeholder="" :value="selInfo.description" disabled=""></textarea>
                          </div>
                        </div>
                      <div class="row" v-if="selInfo.map_coordinates">
                        <iframe
                          width="100%"
                          height="450"
                      ...
                      <div class="row" v-if="!selInfo.map_coordinates"><span>No map data found</span></div>
                  ...
                  <div class="tab-pane fade" id="tab3default">
                    <div v-if="selUsers.length > 0" class=“table-responsive”>
                      <table class="table table-bordered table-striped table-characters">
                        <thead>
                        <tr>
                    ...
                    <div v-if="selUsers.length == 0" class="table-responsive margin-top-10">
                      <span>No Users found</span>
                    </div>
                  </div>
                  <div class="tab-pane fade" id="tab4default">
                    <div v-if="selLists.length > 0" class=“table-responsive”>
                      <table class="table table-bordered table-striped table-characters">
                        <thead>
                        <tr>
                    ...
                    <div v-if="selLists.length == 0" class="table-responsive margin-top-10">
...
export default {
  ...
  created () {
    ...
    if (this.results = this.getMyAccount()) {
      ...
      this.setInfo(this.results.initiatives[0].id)
    }
  },
  methods: {
    showMapUrl: function () {
    ...
    setInfo: function (initid) {
      let initiative = this.results.initiatives.filter(function (initiative) {
        return initiative.id === initid
      })

      this.selInfo = initiative.length > 0 ? initiative[0] : []
      $('#initiativetab1').click()
    },
    showGroups: function () {
    ...
    showUsers: function () {
      axios.get(this.selInfo.users._href, {
        crossdomain: true,
        withCredentials: false,
        headers: {
          'Authorization': `Bearer ${this.ucconfig.apiKey}`
    ...
    showLists: function () {
      axios.get(this.selInfo.ad_lists._href, {
        crossdomain: true,
        withCredentials: false,
        headers: {
          'Authorization': `Bearer ${this.ucconfig.apiKey}`
        ...
        'users': [
          {
            ...
            'agreement': '1',
            'active_status': 'A',
            'last_login': '2020-04-01 16:11:00',
            'time_created': '2020-03-05T12:22:30+0000',
            'date_created': '2020-03-05',
          ...
          },
          {
            ...
            'agreement': '1',
            'active_status': 'A',
            'last_login': '2020-04-03 17:18:26',
